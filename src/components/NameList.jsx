...
export default function NameList({nameModel, postId, locationId, subDivisionId, divisionId, groupId}) {
    let names = nameModel.names
    let nameList = names
    .filter((name)=>(name.postId === postId || postId === null) && (name.locationId === locationId || locationId === null)
